...
Selected Candidate: Sarah Johnson
...
VoteBridge - Secure Online Voting
    `;
          ...
          <div className="bg-green-50 rounded-2xl p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="text-center md:text-left">
                ...
                <p className="text-2xl font-bold text-green-700 mb-1">Sarah Johnson</p>
                <p className="text-green-600">Progressive Alliance</p>
              </div>
